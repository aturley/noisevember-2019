...
primitive ReadFormChunk
  fun apply(data: Array[U8] val, reader: Reader): Array[U8] val ? =>
    reader.append(data)
...
primitive ReadCommonChunk
  fun apply(data: Array[U8] val, reader: Reader): (I16, I16) ? =>
    reader.append(data)
...
primitive ReadSoundDataChunk
  fun apply(reader: Reader, num_channels: I16, sample_size: I16): Array[Array[F64]] ? =>
